...
(function (root, factory) {
  ...
  function (window) {
    ...
    var addNewBtn = function (elem, settings) {
      ...
      if (!existingBtn) {
        elem.parentNode.insertBefore(
          btn,
          settings.btnAfter ? elem.nextSibling : elem
        );
      }
    ...
    var unwrapInBtn = function (elem, settings) {
      ...
      var icon = heading.querySelector(
        "[" + settings.iconAttribute + "]"
      );
      if (icon) {
    ...
    var collapseOthers = function (btn, target, selector, settings) {
      ...
      Array.prototype.forEach.call(
        document.querySelectorAll(
          selector + "." + settings.expandedClass
        ),
        function (content) {
          var btn = document.querySelector(
            "[" + settings.btnAttribute + '="' + content.id + '"]'
          );
    ...
    var toggleContent = function (btn, selector, settings, event) {
      ...
      var target = document.querySelector(
        "#" + btn.getAttribute(settings.btnAttribute)
      );
    ...
    var Constructor = function (selector, options) {
      ...
      publicAPIs.toggle = function (target) {
        toggleContent(
          getBtn(target, selector, settings),
          selector,
          settings
        );
      };
      ...
      publicAPIs.expand = function (target) {
        expandContent(
          getBtn(target, selector, settings),
          getContent(target, settings.btnAttribute),
          settings
        );
      };
      ...
      publicAPIs.setup = function () {
        ...
        Array.prototype.forEach.call(
          ...
          function (content) {
            ...
            if (
              content.classList.contains(settings.expandedClass)
            ) {
